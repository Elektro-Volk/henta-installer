...
export declare type KeyboardButton = ITextButton | ILocationButton | IVKPayButton | IVKApplicationButton;
...
export declare type KeyboardVKPayHash = (IVKPayPayToGroup | IVKPayPayToUser | IVKPayTransferToGroup | IVKPayTransferToUser) & {
    /**
     * Application id
     */
    aid: string | number;
...
export interface IKeyboardProxyButton {
    options: (IKeyboardTextButtonOptions | IKeyboardLocationRequestButtonOptions | IKeyboardVKPayButtonOptions | IKeyboardApplicationButtonOptions);
