...
declare class CommentActionContext<S = Record<string, any>> extends Context<ICommentActionContextPayload, S> {
     ...
     * Returns the likes
     */
    get likes(): Record<string, any> | null;
    /**
