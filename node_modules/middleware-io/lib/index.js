...
const assertMiddlewares = (middlewares) => {
...
const stopMiddleware = (context, next) => { };
/**
 ...
 * ```
 */
const getBeforeMiddleware = (middleware, beforeMiddleware) => (
 ...
 * );
 */
const getEnforceMiddleware = (middleware, beforeMiddleware, afterMiddleware) => (async (context, next) => {
...
class Composer {
     ...
     * Runs middleware before and after the main
     */
    enforce(middleware, beforeMiddleware, afterMiddleware) {
