 ...
 */
export declare const skipMiddleware: <T>(context: T, next: NextMiddleware) => Promise<any>;
/**
 * Does not call `next()` in middleware
 */
export declare const stopMiddleware: <T>(context: T, next: NextMiddleware) => void;
/**
 ...
 * ```
 */
export declare const getBeforeMiddleware: <T>(middleware: Middleware<T>, beforeMiddleware: Middleware<T>) => Middleware<T>;
/**
 ...
 * );
 */
export declare const getEnforceMiddleware: <T>(middleware: Middleware<T>, beforeMiddleware: Middleware<T>, afterMiddleware: Middleware<T>) => Middleware<T>;
/**
